...
- Selected for Exclusive Joint Degree Program  
- Recipient of H. L. Kwee Scholarship  
- Yale School of Law course: Sexuality, Gender, Health, & Human Rights  
- Yale School of Management course: Mastering Influence and Persuasion  
...
- Contributing to another 5 projects: co-designing study protocol, conducting project-relevant quantitative and qualitative analyses, co-writing research papers, recruiting and guiding participants (one-time and longitudinal), conducting field work for data collection by guiding participants through sessions, preparing and editing study materials, operating and calibrating brain activity and heart rate data collection technology.  
- Driving end-to-end research operations, including designing studies, obtaining IRB approval, recruiting and guiding participants (one-time and longitudinal), and managing logistics, scheduling, and resource allocation to keep multi-project workflows on track.  
...
- Researched ways in which youth audiences differ from other target segments in terms of barriers to reaching this segment, subject matter that engages them most, and types of media they frequently consume.  
...
- Received training in qualitative research and reflexivity under Yale School of Public Health’s Dr. LaDrea Ingram.  
- Contributed to a project studying participants of the We Lift Us project, primarily minority women and mothers in the USA.  

### <span style="color:#2F5496;">Capstone Project, Hormonal Birth Control and Behaviour</span>, Singapore  
**Thesis Research and Paper Writing** · Dec 2022 - Apr 2023  

- Analysed data from 5 different studies and 10 different datasets to investigate the relationship between hormonal birth control use and behavioural domains such as risk-taking, competitive decision-making, and negotiation outcomes.  
- Cleaned, processed, coded data, and created visualisations using R.  
- Wrote a full-length research paper presenting and discussing findings.  
- Created a research poster to share findings with the wider community.  

### <span style="color:#2F5496;">Sexual Misconduct Survivor Support, Yale-NUS</span>, Singapore  
**Student Associate** · Aug 2021 - May 2023  

- Suggested ways to fill gaps in the system, such as making resources easier to access and making more information available (for example what to do immediately after a traumatic incident, coping with intrusive thoughts and sensations, telling loved ones, taking legal action).  
- Ideated and created the framework for a pending website for on-campus survivor support.  
- Co-wrote and designed a booklet that serves as the first resource for survivors on the university campus.  

### <span style="color:#2F5496;">Dialectical Behavioral Therapy Group</span>, Malaysia / Singapore  
...
- Created material for 6 monthly newsletters for the organization’s mailing list about mental health and well-being.  
- Collected secondary data on different psychiatric medications and their efficacy for subsequent research.  

### <span style="color:#2F5496;">National Public Health Initiative: Hand-Hygiene through Behavioral Insights</span>, Singapore  
**Student Researcher** · Aug 2021 - Dec 2021  

- Conducted a 10-hour Behavioural Insights-based randomized controlled trial in collaboration with Singapore’s Land Transport Authority to test the hypothesis that increasing the salience of hand sanitizer dispensers increases hand hygiene at public transport stations to reduce COVID-19 transmission in the community.  
- Cleaned and analysed data to determine efficacy of this Behavioural Insights-informed intervention to inform following nation-wide adoption.  

### <span style="color:#2F5496;">Yale-NUS Research: Covid-19 and Mental Health in India</span>, India (Remote) / Singapore  
**Research Assistant** · May 2021 - Jul 2021  

- Guided more than 100 participants through a WhatsApp-based survey by sending daily survey links and acting as their point of contact.  
- Handled administrative duties such as tracking participants’ progress, correcting errors in raw data, and managing payment procedures.  
- Translated messages and survey questions into Hindi.  

### <span style="color:#2F5496;">UnionBank: Nudge Project</span>, Philippines (Remote) / Singapore  
**Research Assistant** · Mar 2021 - Jul 2021  

- Synthesised information from more than 15 behavioural psychology research papers to develop and present solutions for UnionBank in the Philippines to increase uptake of online banking services and reduce in-person COVID-19 transmission.  

### <span style="color:#2F5496;">Yale-NUS Research: Human Attentional Capture Research</span>, Singapore  
**Research Assistant** · May 2020 - Jul 2020  

- Studied more than 10 papers about human attentional function and compiled 12 papers that used eye-tracking technology to study reward learning.  
- Assisted with completion of a research paper about value-driven attentional capture under the supervision of Professor Christopher Asplund of Yale-NUS College and NUS PhD student Chai Jing Wen.  

### <span style="color:#2F5496;">Healthy Mind Online: Mental Health Platform</span>, Singapore  
**Intern** · Jun 2017 - Jul 2017  

- Created brochures and a poster to spread awareness about postpartum depression and the availability of anonymous healthcare services at Healthy Mind Online.  
- Reached out to 7 brands to share these materials with the target segment of new parents.  

---

## <span style="color:#2F5496;">Conferences</span>

- **Society for Neuroscience (SFN) 2025**, San Diego, USA  
  Poster presentation · Nov 15 - 19, 2025  

- **Generation Mental Health (GenMH) 2025**, Nairobi, Kenya (Virtual)  
  Oral presentation · Sept 5 - 6, 2025  

- **International Association for Conflict Management (IACM) 2024**, Singapore  
  Paper presentation · Jun 23 - 26, 2024  
